const ProjectsComponent = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="bg-base-200 shadow-rose-500/30 rounded-lg shadow-md overflow-hidden">
        <img
      ...
      <div className="bg-base-200 shadow-rose-500/30 rounded-lg  shadow-lg overflow-hidden min-h-full">
        <img
        ...
        />
        <div className="p-6 bg-base-200 shadow-rose-500/30 text-center rounded-b-lg md:min-h-full">
          <h3 className="text-xl font-medium text-slate-100 mb-2">
            Flavoured Spaghetti
          </h3>
          <p className="text-slate-400 text-base">
