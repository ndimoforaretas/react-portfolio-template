const ProjectsComponent = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="bg-slate-900 shadow-rose-500/30 rounded-lg shadow-md overflow-hidden">
        <img
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-400 text-base">
            Our wheat flour grinding service provides fresh, high-quality flour
            to businesses and individuals in the area. We use state-of-the-art
            equipment to grind wheat into flour, and we offer a variety of
      ...
      <div className="bg-slate-900 shadow-rose-500/30 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-400 text-base">
            ...
            cooking, and making snacks. It is also a good source of protein and
            fiber.Our gram flour grinding service is a convenient and affordable
      ...
      <div className="bg-slate-900 shadow-rose-500/30 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-400 text-base">
            Our jowar grinding service is a convenient and affordable way to get
            fresh, high-quality jowar flour. We use state-of-the-art equipment
            to grind jowar into a fine powder, which is perfect for making roti,
      ...
      <div className="bg-slate-900 shadow-rose-500/30 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-400 text-base">
            ...
            traditional pounding methods to ensure that our chili powder retains
            its full flavor and aroma.
          </p>
        </div>
      </div>

      <div className="bg-slate-900 shadow-rose-500/30 rounded-lg  shadow-lg overflow-hidden min-h-full">
        <img
        ...
        />
        <div className="p-6 bg-slate-900 shadow-rose-500/30 text-center rounded-b-lg md:min-h-full">
          <h3 className="text-xl font-medium text-slate-100 mb-2">
            Flavoured Spaghetti
          </h3>
          <p className="text-slate-400 text-base">
            <span className="font-medium underline">Our speciality is</span>
            Bappa Flour Mill offers a variety of flavored spaghetti dishes that
            are sure to tantalize your taste buds. We use only the freshest
            ingredients Our flavors include: Mango, spinach
          </p>
        </div>
      </div>
